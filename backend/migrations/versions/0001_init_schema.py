...
def upgrade() -> None:
    ...
    """)
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_containers_geom
        ON containers USING GIST (geom)
    """)
    op.execute("""
        CREATE INDEX IF NOT EXISTS idx_containers_zone
        ON containers (zone_id)
    """)
    op.execute("""
...
def downgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS points_events CASCADE")
    op.execute("DROP TABLE IF EXISTS route_steps CASCADE")
    op.execute("DROP TABLE IF EXISTS routes CASCADE")
    op.execute("DROP TABLE IF EXISTS reports CASCADE")
    op.execute("DROP TABLE IF EXISTS iot_measurements CASCADE")
    op.execute("DROP TABLE IF EXISTS containers CASCADE")
    op.execute("DROP TABLE IF EXISTS zones CASCADE")
    op.execute("DROP TABLE IF EXISTS users CASCADE")
    op.execute("DROP TYPE IF EXISTS route_step_status")
