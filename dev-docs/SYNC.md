...
|---|---|---|
| Backend | Phase 1 | Phase 0 ✅ |
| Frontend | En attente Phase 1 backend ✅ | Phase 0 ✅ |
...
- [ ] Endpoints `/auth/login`, `/auth/register`, `/auth/refresh`, `/users/me`
- [ ] Middleware `require_role`
- [ ] `audit_service` (AUTH_LOGIN_FAILED, USER_REGISTERED…)
- [ ] Rate limiting login (5/5min/IP)
- [ ] Tests : login, RBAC, rate limit, token expiré
- [ ] Swagger à jour
